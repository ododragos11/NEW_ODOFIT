        ...
        <section>
            <div className="bg-[#EAE7E0] py-4 space-y-2">
                <h1 className="text-center font-semibold text-gray-800 text-2xl mx-4">
                    ...
                    <span className="uppercase text-sky-500 font-bold  ">Odofit Hip Brace</span> and
                    get a FREE
            ...
            <div className="flex flex-col md:justify-center  md:flex-row">
                <div className="flex flex-col items-center mt-20 h-fit shadow-xl">
                    ...
                    <p className="uppercase text-sky-500 font-bold md:rounded-b-md -mt-2 text-lg py-2 bg-[#EAE7E0] w-full text-center ">
                        Memory Foam Leg Pillow
                    </p>
                </div>
                <form
